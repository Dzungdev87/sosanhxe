...
export default function ContactPage() {
  return (
    <StaticPage title="Contact Us" description="For questions, corrections, car requests, or suggestions, send a message with as much source context as possible.">
      <p>
        Email:{" "}
        <a href="mailto:contact@sosanhxe.local" className="font-semibold">
          contact@sosanhxe.local
        </a>
      </p>

      <h2>Feedback Form</h2>
      <form action="mailto:contact@sosanhxe.local" method="post" encType="text/plain" className="mt-4 max-w-2xl space-y-4">
